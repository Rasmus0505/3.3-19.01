...
class WalletLedger(Base):
    ...
    operator_user_id: Mapped[int | None] = mapped_column(ForeignKey("users.id", ondelete="SET NULL"), nullable=True, index=True)
    ...
    redeem_batch_id: Mapped[int | None] = mapped_column(
        ForeignKey("redeem_code_batches.id", ondelete="SET NULL"), nullable=True, index=True
    )
    redeem_code_id: Mapped[int | None] = mapped_column(
        ForeignKey("redeem_codes.id", ondelete="SET NULL"), nullable=True, index=True
    )
...
class RedeemCode(Base):
    ...
    __table_args__ = (CheckConstraint("status IN ('active','disabled','abandoned','redeemed')", name="ck_redeem_code_status"),)

    id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    batch_id: Mapped[int] = mapped_column(ForeignKey("redeem_code_batches.id", ondelete="CASCADE"), nullable=False, index=True)
...
class RedeemCodeAttempt(Base):
    ...
    batch_id: Mapped[int | None] = mapped_column(ForeignKey("redeem_code_batches.id", ondelete="SET NULL"), nullable=True, index=True)
    code_id: Mapped[int | None] = mapped_column(ForeignKey("redeem_codes.id", ondelete="SET NULL"), nullable=True, index=True)
