...
import {
  ...
  buildLocalAsrLongAudioWarning,
  releaseLocalAsrWorkerAssetPayload,
  estimateLocalAsrStageRatio,
  buildLocalAsrProgressCounters,
  hasLocalAsrWorkerSupport,
  localSenseWorkerSupportedRuntimes,
  createLocalSenseWorker,
  buildLocalAsrAudioMetadata,
  buildLocalAsrTranscribeOptions,
  runLocalAsrTranscribe,
  estimateLocalAsrStageProgress,
  buildLocalAsrSegmentProgressCounters,
  persistLocalAsrSession,
  loadLocalAsrSession,
  clearLocalAsrSession,
  releaseAllLocalAsrWorkerAssetPayloads,
  transcribeDesktopLocalAsr,
  normalizeServerStatus,
  getOfflineBannerText,
  getOfflineHintText,
  getDesktopSelectionErrorMessage,
  getCloudModelDisplayName,
  getCloudFailureMessage,
  toNormalizedFilename,
  resolveDashscopeObjectKey,
  parseDashscopeUploadErrorPayload,
  buildDashscopeStorageUploadFailureMessage,
  hasLocalLessonImportBridge,
  dispatchLocalLessonUpdateEvent,
  createImportedLessonId,
  normalizeImportedLessonPayload,
  buildImportedCourseRecord,
  buildImportedSentenceRecord,
  buildImportedProgressRecord,
  getDesktopServerDiagnostic,
  getDesktopHelperDiagnostic,
  getDesktopClientUpdateDiagnostic,
  createAbortError,
  nowMs,
  buildWorkerRequestId,
  createFileFromBlob,
  isBlobBackedSourceFile,
  decorateDesktopSourcePath,
  decorateDesktopLinkImportFile,
  resolveDesktopSourcePathCandidate,
  resolveTranscribeDesktopSourcePath,
  buildDesktopSelectedFile,
  materializeDesktopSelectedFile,
  prepareDesktopCloudUploadSourceFile,
  restoreSavedSourceFile,
  buildSubtitleDraftItems,
  buildSubtitleDraftSnapshotFromWorkspace,
  buildSubtitleDraftSnapshotFromTask,
  buildSubtitleDraftSnapshotFromAsrPayload,
