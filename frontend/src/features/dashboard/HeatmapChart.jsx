    ...
    <Card className="relative overflow-hidden rounded-[28px] border border-slate-200/80 bg-white/88 shadow-[0_24px_60px_-46px_rgba(15,23,42,0.65)] backdrop-blur-xl">
      ...
      <CardContent className="relative p-5">
        <div className="flex items-start justify-between gap-3">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-slate-500">Metric 02</p>
            <h3 className="mt-2 text-xl font-black tracking-tight text-slate-950">可理解输入强度</h3>
        ...
        <div className="mt-5 space-y-4">
          <div className="flex items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm font-medium text-slate-600">近 14 天输入强度评分</p>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="rounded-[18px] border border-slate-200/80 bg-slate-50/90 px-3 py-3">
              <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-500">活跃天数</p>
              <p className="mt-1 text-2xl font-black text-slate-950">{metric?.activeDays}/14</p>
            </div>
            <div className="rounded-[18px] border border-slate-200/80 bg-slate-50/90 px-3 py-3">
              <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-500">近期输入量</p>
              <p className="mt-1 text-2xl font-black text-slate-950">{metric?.recentMinutes}m</p>
            </div>
          </div>
        </div>
      </CardContent>
