...
- [ ] **LESS-01**: Generated content from Bottle 1.0 and Bottle 2.0 becomes a normalized lesson record — Phase 3
- [ ] **LESS-02**: User can open generated lessons and review generated sentence content — Phase 3
- [ ] **LESS-03**: Generation progress, partial failures, and success states are visible in product UI — Phase 3

### Learning Experience

- [ ] **LEARN-01**: User can enter spelling/lesson practice from generated lesson content — Phase 3
- [ ] **LEARN-02**: Learning experience remains usable regardless of whether the lesson came from desktop-local or cloud generation — Phase 3
- [ ] **LEARN-03**: Users do not need technical knowledge of ASR routes to continue learning after generation — Phase 6
