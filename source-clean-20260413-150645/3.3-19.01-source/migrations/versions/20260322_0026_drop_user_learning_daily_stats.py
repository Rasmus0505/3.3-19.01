"""drop user learning daily stats

Revision ID: 20260322_0026
Revises: 20260321_0025
Create Date: 2026-03-22 20:20:00
"""
...
def upgrade() -> None:
    ...
    if _has_table("user_learning_daily_stats", schema):
        op.drop_table("user_learning_daily_stats", schema=schema)
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("learning_actions", sa.Integer(), nullable=False, server_default="0"),
        sa.Column("growth_points", sa.Integer(), nullable=False, server_default="0"),
        sa.Column("task_completions", sa.Integer(), nullable=False, server_default="0"),
        sa.Column("completed_lessons", sa.Integer(), nullable=False, server_default="0"),
        sa.Column("engaged_actions", sa.Integer(), nullable=False, server_default="0"),
        sa.Column("stalled_recoveries", sa.Integer(), nullable=False, server_default="0"),
