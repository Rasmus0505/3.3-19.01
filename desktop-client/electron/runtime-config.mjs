...
function buildDefaultConfig({ userDataDir, cacheDir, logDir, tempDir, env = process.env, defaultConfigPath = "" }) {
  ...
  return {
    ...
    cloud: {
      appBaseUrl: normalizeHttpUrl(defaultAppBaseUrl || inferAppBaseUrl(defaultApiBaseUrl)),
      apiBaseUrl: normalizeHttpUrl(defaultApiBaseUrl || inferApiBaseUrl(defaultAppBaseUrl)),
    },
    local: {
